...
def splitted_routeCompute(adj_matrix,num_of_tasks,execution,num_of_rows,MapResult,log_file):
    ...
    while(len(edge_queue)!=0):
        ...
        print("handle edge",current_source_task,"to",current_dest_task,"now,","cur transmission is",current_transmission,", source is",MapResult[current_source_task],"des is",MapResult[current_dest_task])
        ...
        print("best split number is",len(cur_best_route))
...
if __name__ == "__main__":
    ...
    for cur_json in json_list:
        print("-------------")
        print("current json is",cur_json)
